          ...
          children: [
            ...
            RichText(
              text: TextSpan(
                ...
                children: <TextSpan>[
                  TextSpan(text: headline, style: TextStyle(color: Theme.of(context).colorScheme.primary)),
                  ...
                  if (snapshot.hasData) {
                    ...
                    return Expanded(
                        child: GridView.count(
                            ...
                            crossAxisSpacing: 16,
                            childAspectRatio: 2,
                            children: items.map((e) => _Item(type: widget.type, schedule: e)).toList()));
...
class _Item extends StatelessWidget {
  ...
  const _Item({Key? key, required this.type, required this.schedule}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return VPButton(
        onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => PlanPage(short: schedule.short, type: type)),
            ),
        text: schedule.short);
  }
}
